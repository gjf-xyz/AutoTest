...
if __name__ == '__main__':
    r = BaseRequests().get("http://jy001:8081/futureloan/mvc/api/member/register")
    print(r.text)
    canshu = {"mobilephone":18012345674,"pwd":123456}
    r = BaseRequests().post("http://jy001:8081/futureloan/mvc/api/member/register",data= canshu)
    print(r.text)
